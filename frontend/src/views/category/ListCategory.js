...
const ListCategory = () => {
  ...
  useEffect(() => {
    (async () => {
      await axios
        .get(
          `${process.env.REACT_APP_BE_URL_PORT}/web/categories/list?sort=${sort}&search=${search}`,
          {
            headers: {
  ...
  const editCategory = async (id) => {
    await axios
      .post(
        `${process.env.REACT_APP_BE_URL_PORT}/web/categories/update`,
  ...
  const deleteCategory = async (id) => {
    await axios
      .post(
        `${process.env.REACT_APP_BE_URL_PORT}/web/categories/delete`,
        { id },
        {
          headers: {
            Authorization: `Bearer ${
      ...
      <CRow>
        <CCol>
          <CCard>
            ...
            <CModal show={modalEdit} onClose={setModalEdit}>
              ...
              <CModalFooter>
                <CButton
                  ...
                  onClick={() => editCategory(dataItem.id)}
                >
            ...
            <CCardHeader>Tabel Kategori</CCardHeader>
            <CCardBody>
              <div className="d-flex justify-content-between mb-3">
                <div className="d-flex">
                  ...
                  <CButton
                    ...
                    className="button-search-category"
                  >
                ...
                <div className="d-flex">
                  <CSVLink
                    filename="list-category-postme"
                    className="text-white"
                    data={data}
                    headers={headers}
                  >
                    <CButton className="button-csv-category">
                      <FontAwesomeIcon className="mr-2" icon={faFileExport} />
                      CSV
                    </CButton>
                  </CSVLink>
                  <CButton
                    className="button-filter-category ml-2"
              ...
              <CDataTable
                ...
                scopedSlots={{
                  ...
                  deskripsi: (item) => (
                    <td className="input-deskripsi-categories">
